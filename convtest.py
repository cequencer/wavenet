...
out = T.nnet.conv2d(input_reshaped, filters_reshaped, padding='valid', filter_dilation=(dilation, 1))
out = T.reshape(out, (1, -1, 1))
out = K.asymmetric_temporal_padding(out, left_pad=dilation, right_pad=0)
out = T.reshape(out, (1, 1, -1, 1))
out = T.nnet.conv2d(out, filters_reshaped, padding='valid', filter_dilation=(dilation, 1))
out = T.flatten(out)
